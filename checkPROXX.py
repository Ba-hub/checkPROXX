...
#####{INFO}################################################
#Script : checkPROXX
# Working : Check Proxies If Proxy is available to work or not
...
USAGE: python2 checkPROXX.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
...
Examples:
        |
     |--------
     | python2  checkPROXX.py -s 192.168.1.1:8080
     |--------
     | python2  checkPROXX.py -m 192.68.1.2:80,192.68.1.2:53281,etc
     |--------
     | python2  checkPROXX.py -f proxies.txt
     |--------
     | python2  checkPROXX.py -f proxies.txt -d save.txt
     |--------
""")
def main():
